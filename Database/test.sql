...
-- User
INSERT INTO smu.User(firstName, secondName, username, password, email, taxCode, birthDate, idFamily) VALUES ('Mario', 'Rossi', 'user1', 'password1', 'mariorossi7@example.com', 'RSSMRA85M01H501Z', '1985-03-01', 1);
INSERT INTO smu.User(firstName, secondName, username, password, email, taxCode, birthDate, idFamily) VALUES ('Laura', 'Bianchi', 'user2', 'password2', 'laurabianchi7@example.com', 'BNCLRA91C12F205X', '1991-03-12', 1);
INSERT INTO smu.User(firstName, secondName, username, password, email, taxCode, birthDate) VALUES ('Luigi', 'Verdi', 'user3', 'password3', 'luigiverdi3@example.com', 'VRDLGI74P22H223W', '1974-09-22');

-- BankAccount

-- Conto bancario di Mario Rossi
INSERT INTO smu.BankAccount(bankName, balance, ibanBankAccount, taxCode) VALUES ('Banca 1', 3000, 'IT12A1234567890123456789012', 'bankAccount', 'RSSMRA85M01H501Z');
-- Conto bancario di Laura Bianchi
INSERT INTO smu.BankAccount(bankName, balance, ibanBankAccount, taxCode) VALUES ('Banca 1', 2000, 'IT12A1234567890123456789013', 'bankAccount', 'BNCLRA91C12F205X');
-- Conto bancario di Luigi Verdi
INSERT INTO smu.BankAccount(bankName, balance, ibanBankAccount, taxCode) VALUES ('Banca 2', 3200, 'IT12A1234567890123456789014', 'bankAccount', 'VRDLGI74P22H223W');

-- Card

-- Carta di debito senza IBAN associata al conto di Mario Rossi
INSERT INTO smu.Card(cardNumber, cvv, expirationDate, ibanCard, typeCard, ibanBankAccount) VALUES ('1234567890123456', '123', '2029-03-01', NULL, 'debitCard', 'IT12A1234567890123456789012');
